...
if v:version > 703 || v:version == 703 && has('patch1170')
  ...
  execute join(['function! vital#_incsearch#Over#Commandline#Modules#Incsearch#import() abort', printf("return map({'escape_regex': '', 'make': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
