...
let s:___revitalizer_functions___ = {'make': s:___revitalizer_function___('s:make'),'make_search': s:___revitalizer_function___('s:make_search'),'silent_feedkeys': s:___revitalizer_function___('s:silent_feedkeys')}

unlet! s:___revitalizer_sid
delfunction s:___revitalizer_function___

function! vital#_incsearch#Over#Commandline#Modules#Execute#import() abort
